...
const SEED = {
  ...
  products: [
    ...
    // Add-Ons
    { id:'p_lmnt_can', name:'LMNT Sparkling Electrolyte Cans',      category:'Add-Ons', price:499,  unit:'per can',    icon:'', image:'Images for Menu/Images for Menu/Can1.PNG',  description:'Zero-sugar sparkling electrolyte drink. 1000mg sodium. Crisp, refreshing.', popular:true,  inquire:false },
